...
class OrderConfirmationController extends OrderConfirmationControllerCore
{
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'products' => $products,
            'carrier' => $carrier,
            'isoldguest' => $this->checkemail($this->context->customer->email)
        ));
    ...
    {
        $total = Db::getInstance(_PS_USE_SQL_SLAVE_)->getValue('SELECT count(*) FROM '._DB_PREFIX_.'customer WHERE email = "'.pSQL($email_id).'"');
